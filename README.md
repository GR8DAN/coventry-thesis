# A Coventry University Thesis LaTeX Template

I needed a LaTeX template to use in [ShareLaTeX](https://www.sharelatex.com/ "ShareLaTeX") when writing up my thesis. Since I couldn't find one for Coventry University I adapted an existing template. Being based in the Faculty of Engineering, Environment and Computing (EEC) I used the [Cambridge University Engineering Department template](https://github.com/kks32/phd-thesis-template "Cambridge Template on GitHub") as the starting point, though social science schools and faculties should find it applicable.
